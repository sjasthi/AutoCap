...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2021 at 03:58 AM
...
(1, 'అబ్దుల్ కలాం', 'general modified', 'మన జననం ఓ సాధారణమైనది కావచ్చు. కానీ మన మరణం మాత్రం ఒక చరిత్ర సృష్టించేదిగా ఉండాలి'),
(2, 'satyajit ray', 'May ', 'మానవ మనస్తత్వానికి అత్యంత సన్నిహితంగా ఉండే అంశాల్ని చెప్పగలడమే సినిమాయొక్క బలమైన లక్షణంగా ఉండాలి.'),
...
(301, 'Kandukuri Ramu', 'jatiyalu book', 'దానం చేసే గుణం ఇంట్లోనే పుడుతుంది'),
(302, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక మంచి పుస్తకం ఒక మంచి నేస్తంతో సమానం'),
(303, 'Kandukuri Ramu', 'jatiyalu book', 'నిజం ఎప్పటికైనా బయటపడుతుంది'),
(304, 'Kandukuri Ramu', 'jatiyalu book', 'చీకటిని శపిస్తూ కూర్చునేకంటే ఒక దీపాన్ని వెలిగించడం ఎంతో మేలు'),
(305, 'Kandukuri Ramu', 'jatiyalu book', 'గెలవటానికి మొదలుపెట్టడమే సులువైన మార్గం'),
(306, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక మంచి నవ్వు ఒక ఇంటికి సూర్యుని కాంతి లాంటిది'),
(307, 'Kandukuri Ramu', 'jatiyalu book', 'డబ్బును మన అదీనంలో ఉంచుకోవాలేగాని, దానికి బానిస కాకూడదు'),
(308, 'Kandukuri Ramu', 'jatiyalu book', 'ప్రతి క్షణం ఎంతో విలువైనది'),
(309, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక సమస్య వచ్చినప్పుడు దానిని వెంటనే సరిదిద్దుకుంటే ఆ సమస్య పెద్దగా పెరగకుండా అరికట్టగలం'),
(310, 'Kandukuri Ramu', 'jatiyalu book', 'ఎన్నడూ లేదు, జరగదు అని అనవద్దు'),
(311, 'Kandukuri Ramu', 'jatiyalu book', 'గెలిచేవాడు వెనుతిరగడు, వెనుతిరిగేవాడు ఎప్పటికీ గెలిచే అవకాశం లేదు'),
(312, 'Kandukuri Ramu', 'jatiyalu book', 'కష్టపడితేనే ఫలితం వస్తుంది'),
(313, 'Kandukuri Ramu', 'jatiyalu book', 'ఓటమి అంటే ఓడిపోయినప్పుడు కలిగేది కాదు, అదే ఓటమిని తలుచుకుంటూ కృంగిపోవటమే ఓటమి'),
(314, 'Kandukuri Ramu', 'jatiyalu book', 'ఆగిపోయిన గడియారం కూడా రోజుకి రెండుసార్లు సరైన సమయం చూపుతుంది'),
(315, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక చిన్న ఆశ పెద్ద విజయాలను చేకూరుస్తుంది'),
(316, 'Kandukuri Ramu', 'jatiyalu book', 'ముందు చేయాల్సిన వాటిని ముందు చేయండి'),
(317, 'Kandukuri Ramu', 'jatiyalu book', 'బాహ్య సౌందర్యం కంటే అంతఃసౌందర్యం గొప్పది'),
(318, 'Kandukuri Ramu', 'jatiyalu book', 'ఒకసారి అన్న మాటను వెనక్కి తీసుకోలేము'),
(319, 'Kandukuri Ramu', 'jatiyalu book', 'దుబారా చెయ్యొద్దు, కావాలని అడగొద్దు'),
(320, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక్కరి కోసం అందరు, అందరి కోసం ఒక్కరు'),
(321, 'Kandukuri Ramu', 'jatiyalu book', 'విజయానికి అపజయమే తొలి మెట్టు'),
(322, 'Kandukuri Ramu', 'jatiyalu book', 'నడవడిక, ప్రవర్తనలను అనుసరించి ఆ వ్యక్తిలోని గుణగణాలను పరిగణిస్తారు'),
(323, 'Kandukuri Ramu', 'jatiyalu book', 'తీసుకోవడం కన్నా ఇవ్వడం మంచిది'),
(324, 'Kandukuri Ramu', 'jatiyalu book', 'జాగ్రత్తగా, సావధానంగా ఆలోచించి మరీ అడుగు వెయ్యాలి. కంగారుపడి పనిని చక్కబెట్టడానికి ప్రయత్నించకూడదు'),
(325, 'Kandukuri Ramu', 'jatiyalu book', 'అల్పమైన విషయాలకై తగవులాడకండి'),
(326, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక మనిషి ప్రవర్తన అతడి శీలాన్ని తెలియజేస్తుంది'),
(327, 'Kandukuri Ramu', 'jatiyalu book', 'ఉన్నగుడ్డకు సరిపడా కోటు కుట్టించుకోవాలి'),
(328, 'Kandukuri Ramu', 'jatiyalu book', 'క్రూరమైన సరదా అసలు సరదాయే కాదు'),
(329, 'Kandukuri Ramu', 'jatiyalu book', 'తెలివి తక్కువగా మొదలుపెట్టే పని విచారకరమైన ముగింపుకి దారి తీస్తుంది'),
(330, 'Kandukuri Ramu', 'jatiyalu book', 'పని పూజ వంటిది'),
(331, 'Kandukuri Ramu', 'jatiyalu book', 'ఎదుటివారిని మర్యాద పూర్వకంగా పలకరించడం, వారికి గౌరవాన్నిచ్చి మాట్లాడడం సంస్కారవంతుల లక్షణం'),
(332, 'Kandukuri Ramu', 'jatiyalu book', 'మౌనం అంగీకారానికి సూచన'),
(333, 'Kandukuri Ramu', 'jatiyalu book', 'సంకల్పబలం గొప్పది'),
(334, 'Kandukuri Ramu', 'jatiyalu book', 'ఈ ప్రపంచంలో వేటికీ ముగింపులు అనేవి ఉండవు. కేవలం కొత్త ప్రారంభాలు మాత్రమే ఉంటాయి'),
(335, 'Kandukuri Ramu', 'jatiyalu book', 'ప్రతి నాణేనికి రెండు ముఖాలు ఉంటాయి'),
(336, 'Kandukuri Ramu', 'jatiyalu book', 'బతుకు, బతకనివ్వు'),
(337, 'Kandukuri Ramu', 'jatiyalu book', 'మనకున్న జ్ఞానాన్ని ఇతరులతో పంచుకుంటే మనకొచ్చే నష్టమేమీ లేదు'),
(338, 'Kandukuri Ramu', 'jatiyalu book', 'తర్వాత బాధపడటం కన్నా తగిన ముందు జాగ్రత్త చర్యలు తీసుకోవడం మంచిది'),
(339, 'Kandukuri Ramu', 'jatiyalu book', 'నీవు ఏది కాదో దానిని ఎన్నడూ నటించకు'),
(340, 'Kandukuri Ramu', 'jatiyalu book', 'పరిష్కారంలో ఒక భాగంగా వుండు, సమస్యలో కాదు'),
(341, 'Kandukuri Ramu', 'jatiyalu book', '-\'నేను\' కొంత చేయగలను కానీ \'మనం\' అన్నీ చేయగలం'),
(342, 'Kandukuri Ramu', 'jatiyalu book', 'ఊహాశక్తి లేని మనిషి రెక్కలు లేని పక్షి లాంటి వాడు'),
(343, 'Kandukuri Ramu', 'jatiyalu book', 'గుడ్డిగా అనుసరించడం మంచిది కాదు'),
(344, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక మనిషి ఎలాంటి వ్యక్తులతో కలిసి తిరుగుతాడో వారిని బట్టి మనిషి ఎలాంటి వాడో తెలుస్తుంది'),
(345, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక స్వచ్ఛంద సేవకుడు ఇరవై మంది బలవంతంగా, ఇష్టం లేకుండా పని చేసే వారి కన్నా మేలు'),
(346, 'Kandukuri Ramu', 'jatiyalu book', 'వంతెన దగ్గరికి రాకముందే దానిని దాటవద్దు'),
(347, 'Kandukuri Ramu', 'jatiyalu book', 'శ్రమకు తగ్గ ఫలితం తప్పక ఉంటుంది'),
(348, 'Kandukuri Ramu', 'jatiyalu book', 'పండితులకు, వివేకవంతులకు తరగని నిధి అంటే డబ్బు కాదు జ్ఞానం'),
(349, 'Kandukuri Ramu', 'jatiyalu book', 'జరిగిపోయిన దానిని నువ్వు మార్చలేవు. కానీ జరగబోయే దానిని నియత్రించగలవు'),
(350, 'Kandukuri Ramu', 'jatiyalu book', 'అలవాట్లనేవి అంత తేలికగా పోవు'),
(351, 'Kandukuri Ramu', 'jatiyalu book', 'నువ్వు ఏ పొరపాటు చేయలేదంటే, నువ్వు ఏ పని చేయలేదని అర్ధం'),
(352, 'Kandukuri Ramu', 'jatiyalu book', 'తప్పు చేయడం కన్నా దానికి సంజాయిషీ ఇచ్చుకోవటానికే ఎక్కువ సమయం పడుతుంది'),
(353, 'Kandukuri Ramu', 'jatiyalu book', 'క్షమించడం గొప్ప గుణం'),
(354, 'Kandukuri Ramu', 'jatiyalu book', 'నిమ్మకాయ పులుపును రుచి చూసినప్పుడే మనకు పంచదార తీపి తెలుస్తుంది'),
(355, 'Kandukuri Ramu', 'jatiyalu book', 'అన్ని వృత్తులలో అరకొర జ్ఞానం ఉన్నవాడు ఏ వృత్తిలోనూ నిపుణుడు కాలేడు'),
(356, 'Kandukuri Ramu', 'jatiyalu book', 'ఈ రోజు చేయగలిగిన దాన్ని రేపటికి వాయిదా వేయు'),
(357, 'Kandukuri Ramu', 'jatiyalu book', 'చిన్నచిన్న పనులు చేయటానికి ఇష్టపడని వ్యక్తి పెద్ద పనులు చేయటానికి అర్హత పొందలేడు'),
(358, 'Kandukuri Ramu', 'jatiyalu book', 'అసలు చేయని దాని కన్నా ఆలస్యంగానైనా చేయటం మంచిది'),
(359, 'Kandukuri Ramu', 'jatiyalu book', 'వర్షం కేవలం ఒకే ఇంటికప్పు మీద కురవదు'),
(360, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక అబద్ధం ఎన్నో అబద్ధాలకు దారి తీస్తుంది'),
(361, 'Kandukuri Ramu', 'jatiyalu book', 'త్వరగా పడుకోవటం, త్వరగా మేల్కోవటం మనిషిని ఆరోగ్యవంతునిగా, ధనవంతునిగా, తెలివిగల వానిగా చేస్తాయి'),
(362, 'Kandukuri Ramu', 'jatiyalu book', 'తెలుసుకోవటమే సరిపోదు, దాన్ని తప్పనిసరిగా ఉపయోగించాలి. చేయాలనుకోవటమే సరిపోదు, దాన్ని తప్పనిసరిగా చేయాలి'),
(363, 'Kandukuri Ramu', 'jatiyalu book', 'దుష్టుల సాంగత్యంలో ఉండటం కన్నా ఒంటరిగా ఉండటం మంచిది'),
(364, 'Kandukuri Ramu', 'jatiyalu book', 'కొండను తవ్వి తియ్యాలనుకునే వ్యక్తి కూడా చిన్న చిన్న రాళ్లను తొలగించటంతో పని ప్రారంభిస్తాడు'),
(365, 'Kandukuri Ramu', 'jatiyalu book', 'ఓపిక అనేది ఒక చేదు మొక్క కానీ దానికి మధురమైన ఫలం ఉంటుంది'),
(366, 'Kandukuri Ramu', 'jatiyalu book', 'ప్రాణమున్నంత వరకు మనిషికి ఆశ ఉంటుంది'),
(367, 'Kandukuri Ramu', 'jatiyalu book', 'శాశ్వతమైన ఆనందం కోసం తాత్కాలికమైన బాధని భరించటానికి సిద్ధంగా ఉండాలి'),
(368, 'Kandukuri Ramu', 'jatiyalu book', 'నీ కళను సాధన చేయకపోతే అది నిన్ను విడిచి వెళ్ళిపోతుంది'),
(369, 'Kandukuri Ramu', 'jatiyalu book', 'తన మీదకి విసిరిన రాళ్లతో ఇల్లు కట్టుకునే వాడు నిజమైన విజేత'),
(370, 'Kandukuri Ramu', 'jatiyalu book', 'తప్పులు మాత్రమే ఎన్నే వాళ్లకు అవి తప్ప ఏవీ కనిపించవు'),
(371, 'Kandukuri Ramu', 'jatiyalu book', 'చిరుప్రాయంలో అయిన అలవాట్లు చిరకాలం ఉంటాయి'),
(372, 'Kandukuri Ramu', 'jatiyalu book', 'బాలుడికి అతడు వెళ్ళవలసిన మార్గంలోనే శిక్షణ ఇవ్వండి'),
(373, 'Kandukuri Ramu', 'jatiyalu book', 'సంతృప్తి అనేది సంపదలో ఉండదు. కాని కోరికలు తక్కువగా ఉండటంలో ఉంటుంది'),
(374, 'Kandukuri Ramu', 'jatiyalu book', 'తొందరపాటుతో పైకి ఎక్కేవాళ్ళు అకాస్మాత్తుగా పడిపోతారు'),
(375, 'Kandukuri Ramu', 'jatiyalu book', 'యుద్ధం మొదలు అయినప్పుడు నరకద్వారాలు తెరుచుకుంటాయి'),
(376, 'Kandukuri Ramu', 'jatiyalu book', 'ఏదైనా విషయం తెలియక పోవడం సిగ్గుచేటు కాదు, దాన్ని తెలుసుకోవడానికి ప్రయత్నించకపోవడం పొరపాటు'),
(377, 'Kandukuri Ramu', 'jatiyalu book', 'వాయిదా వేయడం అనేది కాలాన్ని అపహరించే దొంగ'),
(378, 'Kandukuri Ramu', 'jatiyalu book', 'తన ఇంట్లో సంతోషాన్ని పొందేవాడు అందరి కన్నా ఆనందంగా ఉంటాడు'),
(379, 'Kandukuri Ramu', 'jatiyalu book', 'మనం పోగొట్టుకునే ఆఖరి వస్తువు ఆశ'),
(380, 'Kandukuri Ramu', 'jatiyalu book', 'సంతోషం, దుఃఖం ఇరుగుపొరుగువారు'),
(381, 'Kandukuri Ramu', 'jatiyalu book', 'ఆకలిగొన్న వానికి నువ్వు ఇవ్వగలిగే మంచి సలహా రొట్టె ఇవ్వటం'),
(382, 'Kandukuri Ramu', 'jatiyalu book', 'ఏ మనిషీ ఒక్కసారిగా చెడ్డవాడు కాలేడు'),
(383, 'Kandukuri Ramu', 'jatiyalu book', 'చిన్నచిన్న నీటి బిందువులన్నీ కలిస్తేనే నదులు, సముద్రాలు ఏర్పడతాయి'),
(384, 'Kandukuri Ramu', 'jatiyalu book', 'రోజూ ఒక ఆపిల్ తింటే డాక్టర్ ని ఎల్లప్పుడూ దూరంగా ఉంచుతుంది'),
(385, 'Kandukuri Ramu', 'jatiyalu book', 'ఎవరినైనా విమర్శించేటప్పుడు ముందు ఆ వ్యక్తి ఉన్న పరిస్థుతులు గమనించాలి'),
(386, 'Kandukuri Ramu', 'jatiyalu book', 'చేసిన గాయాలు ఇసుకలో, చేసిన మేలును పాలరాతి మీద రాయాలి'),
(387, 'Kandukuri Ramu', 'jatiyalu book', 'ప్రతి ఒక్కరూ తప్పుల్ని ఎంచగలరు. కానీ కొంతమందే బాగా చేయగలరు'),
(388, 'Kandukuri Ramu', 'jatiyalu book', 'పాడాలని కోరుకునే వారికి ఎప్పుడూ పాట దొరుకుతుంది'),
(389, 'Kandukuri Ramu', 'jatiyalu book', 'ఇతరులను పడగొట్టి నిచ్చెన ఎక్కలేవు'),
(390, 'Kandukuri Ramu', 'jatiyalu book', 'తెలివైన వాడు ఇతరుల తప్పుల నుంచి నేర్చుకుంటాడు, మూర్ఖుడు తన తప్పుల నుంచే నేర్చుకుంటాడు'),
(391, 'Kandukuri Ramu', 'jatiyalu book', 'విజ్ఞానం వారసత్వమూ కాదు. వీలునామా ద్వారా వచ్చే సొత్తూ కాదు'),
(392, 'Kandukuri Ramu', 'jatiyalu book', 'మూర్ఖుడు డబ్బు సంపాదించవచ్చు, కానీ ఖర్చు పెట్టడానికి తెలివైనవాడై ఉండాలి'),
(393, 'Kandukuri Ramu', 'jatiyalu book', 'తనను తాను అభివృద్ధి చేసుకున్న వ్యక్తి రెండుసార్లు పుట్టినట్లు'),
(394, 'Kandukuri Ramu', 'jatiyalu book', 'రెండు పడవల మీద కాళ్లు పెట్టడం మొదటికే మోసం'),
(395, 'Kandukuri Ramu', 'jatiyalu book', 'వెదురును వంచాలంటే మొక్కగా ఉన్నప్పుడే మొదలుపెట్టాలి'),
(396, 'Kandukuri Ramu', 'jatiyalu book', 'అందరికీ స్వర్గానికి వెళ్లాలనే కోరిక ఉంటుంది కానీ చావడానికి ఎవరూ సిద్ధంగా ఉండరు'),
(397, 'Kandukuri Ramu', 'jatiyalu book', 'ఆరోగ్యకరమైన జీవితానికి రహస్యం ఇవ్వటమే'),
(398, 'Kandukuri Ramu', 'jatiyalu book', 'ఏప్రిల్ నెలలో కురిసే వాన జల్లులు మే నెలలో పువ్వులను పూస్తాయి'),
(399, 'Kandukuri Ramu', 'jatiyalu book', 'కోపం వచ్చినప్పుడు నువ్వు ఒక క్షణం ఓపిగా ఉంటే వంద రోజుల దుఃఖం నుంచి తప్పించుకోవచ్చు'),
(400, 'Kandukuri Ramu', 'jatiyalu book', 'ఒక పనిని హృదయపూర్వకంగా ఇష్టపడి చేసేవాళ్లకు అసంభవం ఉండదు'),
(401, 'చలం', 'ఆత్మకథ', 'ఒక్కక్కరం ఒక్కొక్క పిచ్చితో పుడతాం ఎంత ప్రయత్నించనీ తప్పించుకోలేము తప్పించుకున్నాం  తప్పించుకుంటున్నాం  తప్పించుకోగలం అనుకుంటాం అంతే'),
(402, 'చలం', 'ఏది తప్పో, ఏది ఒప్పో మీ అంతరాత్మ చెబుతూనే ఉంటుంది.', 'ఏది తప్పో ఏది ఒప్పో మీ అంతరాత్మ చెబుతూనే ఉంటుంది. తెలియదనడం ఆత్మవంచన. '),
(403, 'Jasthi', 'ICS499', 'programming in PHP is fun'),
(404, 'sample', 'ics499', 'Doing a final project in PHP and MySQL should be cool!');
